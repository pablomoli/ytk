...
**Superseded by asset 25 (2026-08-08):** the "% of ceiling" reading below
is retracted. E3's random-direction control puts ARI-vs-themes anywhere in
0.31-0.48 when 25 arbitrary directions are removed from the 1024-d space,
so 0.335 is one draw from a wide band, not a fixed bar. The direction of
the gap stands; the ratio does not.
