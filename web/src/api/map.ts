...
// KDE contour polylines by level index + SCMS ridge polylines.
export type MapTerrain = { h: number; levels: number[]; contours: Array<{ lv: number; path: number[][] }>; ridges: number[][][] }
