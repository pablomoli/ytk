...
export function nearestValidationPath(path: string, errors: Record<string, string>): string | undefined {
  return Object.keys(errors).find((errorPath) => path === errorPath || errorPath.startsWith(`${path}.`))
}
