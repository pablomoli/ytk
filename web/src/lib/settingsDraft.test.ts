...
const config = {
  ...
  hub: { host: '127.0.0.1', port: 6969, favicon: '✦', cadence_minutes: {}, imessage_gap_minutes: 20, tags: ['design'], pinterest_feeds: [], enrich_tone: '' },
  whisper_model: 'base', memo_notify: [], github_repos: [],
